                                    ...
                                    @foreach ($allproducts as $key => $product)
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <div class="mt-md-0 mt-2">
                                                    ...
                                                    <div class="dropdown-menu bg-white rounded-0 pb-0">
                                                        <a onclick="product_image_edit({{ $product['id'] }})"
                                                            class="dropdown-item font-weight-400 small_font border-bottom mb-1">
                                                            <i class="fa fa-wrench pe-3" aria-hidden="true"></i>
                                                            Product Advance Edit
                                                        </a>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <img src="{{ asset('assets_front_end/image/products/defaultIcon.png') }}"
                                                        style="width:50px ; height:50px">
                                                @endif
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                @if ($product['getProductType'] != null)
                                                    {{ $product['getProductType']['product_type'] }}
                                                @else
                                                    {{ '-' }}
                                                @endif
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                @if ($product['getProductModel'] != null)
                                                    {{ $product['getProductModel']['model_name'] }}
                                                @else
                                                    {{ '-' }}
                                                @endif
                                            </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group mb-3">
                                <label class="form-label" for="edit_product_select_category">Select Product
                                    Category</label>
