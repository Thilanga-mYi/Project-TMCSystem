                        ...
                        <div class="card rounded-0 shadow-sm border-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label class="form-label small_font" for="new_invoice_types">Select
                                                Invoice Type</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            <label class="form-label small_font" for="new_invoice_ref">Invoice Ref#</label>
                                            <input id="new_invoice_pay_done_date" name="new_invoice_pay_done_date" type="date"
                                                class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            <label class="form-label small_font" for="new_invoice_billing_to">Billing
                                                To</label>
                                            ...
                                            <input type="hidden" id="new_invoice_billing_to_id"
                                                name="new_invoice_billing_to_id" />
